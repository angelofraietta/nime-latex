...
% Modified by Angelo Fraietta 10 June 2018
...
\togglefalse{blindreview} % Leave this intact as it is our default

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% uncomment line below to make blind
%\toggletrue{blindreview} 
...
A convenient flag has been provided that will allow you to easily mask any text or reference that could be used to identify you as the author. To enable the feature, uncomment the \texttt{\textbackslash toggletrue{blindreview}} line near the top of the file. 

To mask text that will identify you, place the text you want to hide inside the \textbackslash anonymize function. If you have enabled the blind review feature by uncommenting the \texttt{\textbackslash toggletrue{blindreview}} line, \anonymize{you will notice that this text has been blackened out and you don't need to rewrite it when it is time to publish}. Comment the line \texttt{\textbackslash toggletrue{blindreview}} when you are ready to publish. 

Additionally, you will need to separate your personal references into two separate files. These have been named in this example \texttt{personal.bib} and \texttt{personal-anon.bib}. Mask all identifying information in the \texttt{personal-anon.bib} file, however, keep the citation key the same as that in your \texttt{personal.bib}.
You will note that \cite{mypublication} and \cite{myotherpublication} were written by me, so in blind mode, it will use the \texttt{personal-anon.bib} file. When switching to and from \texttt{blind} mode, you may need to delete your auxiliary files or do a bibliography refresh to clear the \LaTeX\ cache..
...
\iftoggle{blindreview}{%
	\bibliography{nime-references,personal-anon}
}{%
	\bibliography{nime-references,personal} 
}
