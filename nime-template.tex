...
%\documentclass[blind]{nime-alternate} % Comment out when publishing final version
\documentclass[publish]{nime-alternate} % Uncomment when publishing final version

\usepackage[blind]{anonymize}
%\usepackage[publish]{anonymize}
