...
\newtoggle{anon}
%you have to watch out here because if you are doing the swap on your bibliography, it appears cached, so you need to do a compile, then bibliography, then compile again
%\toggletrue{anon}
\togglefalse{anon}
